...
// Matches the login dialog size used by the Office and Outlook add-ins, see
// dialogWidthPx/dialogHeightPx in the shared lf-login component.
export const LOGIN_WINDOW_WIDTH_PX = 1000;
export const LOGIN_WINDOW_HEIGHT_PX = 800;

// Loads that finish sooner than this show no spinner, so fast responses
// don't flash one.
